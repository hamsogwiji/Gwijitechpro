...
global.location = process.env.LOCATION || "Kenya, Mombasa";

// Creator details
global.ownernumber = process.env.OWNER_NUMBER || '254743710474';
global.ownername = process.env.OWNER_NAME || 'GwijiTech';
global.botname = process.env.BOT_NAME || 'GWIJITECH-PRO-V1';
...
global.author = process.env.AUTHOR || 'GWIJITECHPRO\n\nContact: +254743710474';
// Default settings 2
